...
$string['error_empty_emaildomain']                          = 'Error: With an empty domain.';
$string['error_invalid_group']                              = 'Error: Invalid group!';
$string['error_wrong_emaildomain']                          = 'Error: Wrong email domain!';
$string['info_plugin_remains_deactivated']                  = 'The plugin remains deactivated';
...
$string['setting_emaildomain']                              = 'Not sending email domain';
$string['setting_emaildomain_help']                         = 'This domain is used for the temporary email address of the companion user. It should be a domain to which no e-mails can be sent.';
...
$string['setting_group_default']                            = 'Default group setting';
